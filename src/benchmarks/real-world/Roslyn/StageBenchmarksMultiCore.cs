...
namespace CompilerBenchmarks
{
    ...
    public class StageBenchmarksMultiCore
    {
        ...
        {
            var options = _comp.Options.WithConcurrentBuild(true);
        ...
        public EmitResult CompileMethodsAndEmit()
        {
            ...
            return _comp.WithOptions(_comp.Options.WithConcurrentBuild(true)).Emit(_peStream);
        }
